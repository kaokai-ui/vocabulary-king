export const enMessages = {
  ...
  wordChainHint: "Fill letters into the interlocking grid so every word is spelled correctly, drawn from the current track.",
  wordChainShowHint: "Show hint",
  wordChainHideHint: "Hide hint",
  ...
  wordChainClearAll: "Clear all",
  wordChainChecking: "Not quite right yet — fix the letters in the red cells.",
  wordChainComplete: "Level complete!",
  wordChainNext: "Next level",
  wordChainRestart: "Retry",
  wordChainSkip: "Skip",
  wordChainLoading: "Generating a word-chain level...",
  wordChainError: "Could not generate a level. Please skip to the next one.",
  wordChainBoardTooLarge: "This board is too large — please skip.",
  wordChainUnavailable: "This track has too few usable words to build a word chain. Try another vocabulary track.",
  wordChainLevel: "Level {n}"
};
